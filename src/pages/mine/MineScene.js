                ...
                renderHeader() {
                    return ( 
                        ...
                        <View style={styles.topContainer}>
                            <TouchableOpacity>
                                <Image style={[styles.icon, {marginRight: 15}]}
                                       source={require('../../assets/images/mine/icon_navigation_item_message_white.png')}/>
                            </TouchableOpacity>
                            <TouchableOpacity>
                        ...
                        <View style={styles.userContainer}>
                            <Image style={styles.avatar} source={require('../../assets/images/mine/mo.jpg')}/>
                            <View>
                                <View style={{flexDirection: 'row'}}>
                                    <Heading1 style={{color: 'white'}}>莫笙</Heading1>
                        ...
                        [
                            ...
                            [{
                                ...
                                },
                                {
                                    title: '会员中心',
                                    subtitle: 'v15',
                                    image: require('../../assets/images/mine/icon_mine_mineorder.png')
                                },
                                {
                                    title: '积分商城',
                                    subtitle: '好礼已上线',
                            ...
                            [{
                                ...
                                },
                                {
                                    title: '关于用友',
                                    subtitle: '我要合作',
                                    image: require('../../assets/images/mine/yonyou.png')
                                }
                            ]
                        ]
                    )
