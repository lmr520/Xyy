...
SelectToOpenLeftSideMenu(){
  ...
  renderItem(line) {
    ...
    //   const xyy = xyys[index];
      itemAry.push(
        ...
        //   </Text>
        // </View>
        <View style={{width:170,marginLeft:3,top:5}}>
        <Image 
        source={require('../assets/images/ma.jpg')}
        style={{width:170,height:130}}></Image>
       ...
       <Text style={ { marginBottom: 10 } }>
        ...
        <Button
          ...
          buttonStyle={ { width:110,height:40,marginBottom:10} }
          title='VIEW NOW' />
      ...
      itemAry.push(
        ...
        //   </Text>
        // </View>
        <View style={{width:170,marginRight:3,top:5}}>
        <Image 
        source={require('../assets/images/ma.jpg')}
        style={{width:170,height:130}}></Image>
        <View style={{alignItems:'center',justifyContent:'center'}}>
  ...
  render() {
    ...
    return (
      ...
      >
       <View style={{width:width,flexDirection:'row', backgroundColor: '#FFF'}}>
      ...
      <SearchBar
                    containerStyle={ style = { height: 50, borderRadius: 5, borderWidth: 1, borderColor: '#FFF',backgroundColor:'#FFF' } }
